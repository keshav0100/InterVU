  ...
  const feedbackres =
    feedback.length > 0
      ? feedback.reduce((acc, item) => acc + item.rating, 0) /
        feedback.length /
        10
      : 0; // Normalize to a 10-point scale

  const formattedFeedbackRes = feedbackres.toFixed(2); // Format to 2 decimal places
      ...
      {feedback.length == 0 ? (
        ...
        <>
          ...
          <h2 className="font-bold text-2xl">
            Here is your interview feedback and areas of improvement
          </h2>

          <h2 className="text-primary text-lg my-3">
            Your overall interview rating:{" "}
            <strong>{formattedFeedbackRes / 10}/10</strong>
          </h2>
